...
//import com.change.service.quartz.QuartzTimedTaskService;
...
//     * @return 查询结果
//     */
//    @RequestMapping(value = "/change/quartz/getquartztimedtasks", method = RequestMethod.GET)
...
//     * @return 定时任务记录信息
//     */
//    @RequestMapping(value = "/change/quartz/postqrtzcrontriggers", method = RequestMethod.POST)
...
//     * @return id
//     */
//    @RequestMapping(value = "/change/quartz/deletequartztimedtasks/{id}", method = RequestMethod.DELETE)
...
//     * @return
//     */
//    @RequestMapping(value = "/change/quartz/startJobs", method = RequestMethod.GET)
...
//     * @return
//     */
//    @RequestMapping(value = "/change/quartz/startonejobs/{id}", method = RequestMethod.GET)
...
//     * @return
//     */
//    @RequestMapping(value = "/change/quartz/shutdownjobs", method = RequestMethod.GET)
...
//     * @return
//     */
//    @RequestMapping(value = "/change/quartz/shutdownonejobs/{id}", method = RequestMethod.GET)
